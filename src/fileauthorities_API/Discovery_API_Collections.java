...
public class Discovery_API_Collections {
	...
	public void verifyFileAuthority() {
		...
		Response resp = given().accept(ContentType.XML).when().get(
				"http://test.discovery.nationalarchives.gov.uk/API/fileauthorities/v1/collection/Family?direction=NEXT&includeCursor=true");

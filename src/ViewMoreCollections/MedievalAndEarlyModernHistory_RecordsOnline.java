...
public class MedievalAndEarlyModernHistory_RecordsOnline extends Wrapper_methods {
    @Test
    public void MedievalAndEarlyModernHistory_RecordsOnline() throws IOException,InterruptedException{
        ...
        Assert.assertEquals("Medieval and early modern history", actual2);
        driver.close();
    }
}

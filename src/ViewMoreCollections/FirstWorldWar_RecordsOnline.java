...
public class FirstWorldWar_RecordsOnline extends Wrapper_methods {
    @Test

    public void FirstWorldWar_RecordsOnline() throws IOException, InterruptedException{
        ...
        Assert.assertEquals("First World War", actual2);
        //driver.close();
    }

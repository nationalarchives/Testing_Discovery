...
public class SecondWorldWar_RecordsOnline extends Wrapper_methods {

    @Test

    public void SecondWorldWar_RecordsOnline() throws IOException,InterruptedException{
        ...
        Assert.assertEquals("Second World War", actual2);
        driver.close();

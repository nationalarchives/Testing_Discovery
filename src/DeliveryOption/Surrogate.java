...
public class Surrogate extends Wrapper_methods {
	...
	public void surrogate() throws Exception {
		...
		String deliveryOptionType = sheet.getRow(0).getCell(14).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(14).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(14).getStringCellValue();
		String expectedOnsitePublicDo = sheet.getRow(3).getCell(14).getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(14).getStringCellValue();
		...
		Assert.assertTrue(Staffcheck.contains("Surrogate"));
		...
		Assert.assertTrue(onsitepublic.contains("Surrogate"));
		...
		Assert.assertTrue(Offsitecheck.contains("Surrogate"));

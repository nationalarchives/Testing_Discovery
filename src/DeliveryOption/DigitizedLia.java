...
public class DigitizedLia extends Wrapper_methods {

	@Test

	public void digitizedLia() throws Exception {
		...
		String deliveryOptionType = sheet.getRow(0).getCell(5).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(5).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(5).getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(5).getStringCellValue();
		...
		Assert.assertTrue(Staffcheck.contains("DigitizedLia"));
		...
		Assert.assertTrue(offsitecheck.contains("DigitizedLia"));

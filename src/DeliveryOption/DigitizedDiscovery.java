...
public class DigitizedDiscovery extends Wrapper_methods {
	...
	public void digitizedDiscovery() throws Exception {
		...
		String deliveryOptionType = sheet.getRow(0).getCell(13).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(13).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(13).getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(13).getStringCellValue();

...
public class WO416 extends Wrapper_methods {
	...
	public void paidSearch() throws Exception {
		...
		String deliveryOptionType = sheet.getRow(0).getCell(31).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(31).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(31).getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(31).getStringCellValue();

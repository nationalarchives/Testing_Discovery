...
public class MouldTreatment extends Wrapper_methods {
	...
	public void mouldTreatment() throws Exception {
		...
		String deliveryOptionType = sheet.getRow(0).getCell(12).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(12).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(12).getStringCellValue();
		String expectedOnsitePublicDo = sheet.getRow(3).getCell(12).getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(12).getStringCellValue();

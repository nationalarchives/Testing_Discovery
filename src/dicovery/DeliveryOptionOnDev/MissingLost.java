...
public class MissingLost {
	...
	public void missingLost() throws Exception {
		...
		String deliveryOptionType = sheet.getRow(0).getCell(11)
				.getStringCellValue();
		String iaid = sheet.getRow(1).getCell(11).getStringCellValue();
		String expectedValeStaff = sheet.getRow(2).getCell(11)
				.getStringCellValue();
		...
		System.out.println(driver.findElementByXPath(
				...
				"innerHTML"));
		System.out.println(driver.findElementByXPath(
				"(//div[@class='order-option-wrapper'])").getText());
		...
		String actualDO = driver.findElementByXPath(
				"//div[@class='order-option-wrapper']").getText();

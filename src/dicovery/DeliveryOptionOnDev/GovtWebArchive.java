...
public class GovtWebArchive {
	

	
	@Test
	
	public void govtWebArchive() throws Exception{
		...
		String deliveryOptionType = sheet.getRow(0).getCell(9).getStringCellValue();
		String iaid = sheet.getRow(1).getCell(9).getStringCellValue();
		String expectedValeStaff = sheet.getRow(2).getCell(9).getStringCellValue();
...
System.out.println(driver.findElementByXPath("(//div[@class='order-option-wrapper'])").getText());
			...
			Assert.assertTrue(Staffcheck.contains("GovtWebArchive"));

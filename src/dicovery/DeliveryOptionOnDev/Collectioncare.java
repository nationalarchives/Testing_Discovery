...
public class Collectioncare {
	...
	public void collectionCare() throws Exception {
		...
		String deliveryOptionType = sheet.getRow(0).getCell(3)
				.getStringCellValue();
		String iaid = sheet.getRow(1).getCell(3).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(3)
				.getStringCellValue();
		String expectedOnsitePublicDo = sheet.getRow(3).getCell(3)
				.getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(3)
				.getStringCellValue();

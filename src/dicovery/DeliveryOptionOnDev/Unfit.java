package dicovery.DeliveryOptionOnDev;
...
public class Unfit {
	...
	public void unfit() throws Exception{
		File src = new File("./data/ALLOptionsDev.xlsx");
		XSSFWorkbook book = new XSSFWorkbook(src);

		XSSFSheet sheet = book.getSheetAt(0);

		String deliveryOptionType = sheet.getRow(0).getCell(17)
				.getStringCellValue();
		String iaid = sheet.getRow(1).getCell(17).getStringCellValue();
		String expectedStaffDo = sheet.getRow(2).getCell(17)
				.getStringCellValue();
		String expectedOnsitePublicDo = sheet.getRow(3).getCell(17)
				.getStringCellValue();
		String expectedOffisteDo = sheet.getRow(4).getCell(17)
				.getStringCellValue();

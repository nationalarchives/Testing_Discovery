...
public class PageCheckRequestMore1000Characters extends Wrapper_methods {

	@Test
	public void PageCheckRequestACopy() throws IOException, InterruptedException {

		launchDriver("http://test.discovery.nationalarchives.gov.uk/pagecheck/addtobasket/C11443396?readertype=offsite",
				"chrome");
		...
		driver.findElementByXPath("//*[@id='CustomerInstructions']")
				.sendKeys("Please tell us as much as you can about what you want copied. Where possible, "

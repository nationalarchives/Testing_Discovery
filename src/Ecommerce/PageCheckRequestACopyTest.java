...
public class PageCheckRequestACopyTest extends Wrapper_methods {

	@Test
	public void PageCheckRequestACopy() throws IOException, InterruptedException {

		launchDriver("http://test.discovery.nationalarchives.gov.uk/pagecheck/start/C6553048", "chrome");
		...
		// driver.findElementByLinkText("Get started").click();

		clickByClassName("discoveryPrimaryCallToActionLink");

		/*
		 * // click get started //clickbyLinkText("Get started");
		 * clickByClassName("discoveryPrimaryCallToActionLink");
		 * 
		 * driver.findElementByXPath(
		 * "//*[@class='discoveryPrimaryCallToActionLink']").click();
		 * 
		 ...
		 * 
		 * driver.findElementByXPath("//*[@id='CustomerInstructions']").
		 * sendKeys( "Research");
		 * 
		 * // enterTextById("//textarea[@id='CustomerInstructions']",
		 * "Research");
		 * 
		 * 
		 * 
		 ...
		 * 
		 * Thread.sleep(3000); // click the checkout
		 * 
		 * clickbyXpath("//input[@value='Checkout']");
		 * 
		 * Thread.sleep(3000); // Create the account or sign in // Enter email
		 * 
		 * driver.findElementById("UserName")
		 * .sendKeys("discovery@nationalarchives.gov.uk");
		 * 
		 * Thread.sleep(3000);
		 * 
		 * // Enter password

...
public class LetUsKnow_RelatedMaterial_AllFields extends Wrapper_methods {
    @Test

    public void LetUsKnow_RelatedMaterial_AllFields() throws IOException, InterruptedException{

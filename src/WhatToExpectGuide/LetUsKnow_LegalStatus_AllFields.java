...
public class LetUsKnow_LegalStatus_AllFields extends Wrapper_methods {
    @Test

    public void LetUsKnow_LegalStatus_AllFields() throws IOException, InterruptedException{
        ...
        // Select Legal Status from the dropdown
